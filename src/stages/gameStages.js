...
export const gameStages = {
  ...
  BEDROOM: {
    ...
    place: 'Спальня',
    narrator:
      'Находясь в спальне, вы замечаете одноместную кровать, стоящую в центре комнаты, высокий шкаф из темного дерева и тумбу, которая находится в углу. Комнату освещает свет, доходящий с гостиной.',
    actions: [
